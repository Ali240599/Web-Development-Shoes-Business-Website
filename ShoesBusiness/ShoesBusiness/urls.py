"""
URL configuration for ShoesBusiness project.
...
from customer.views import Index, Menu, login_view, register, user_history, product, LogoutView, product_list, user_orders, add_to_cart, remove_from_cart, view_cart, view_order
...
urlpatterns = [
    ...
    path('remove/<int:item>/' , remove_from_cart, name='remove_from_cart'),
